...
# Car class  from Vehicle
class Car(Vehicle):

 # Car build
    def __init__(self, make, model, color, fuelType, options, engineSize, numDoors):
        super().__init__(make, model, color, fuelType, options)  # Super class 
# List car's attributes
...
if __name__ == '__main__':
 ...
 # Prepare some vehicles
    ...
    pickup3 = Pickup("MAKE6", "MODEL6", "YELLOW", "PETROL", "OPTIONS6", "CAB STYLE3", "BED LENGTH3")
